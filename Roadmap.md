AI Automation Architect - Comprehensive Learning Roadmap
...
Core Resource: Udemy - 100 Days of Code: The Complete Python Pro Bootcamp (Dr. Angela Yu)
    ...
    Week 1: Environment Setup & Basic Syntax
        ...
        Projects:
            ...
            Project 01: Personal Coding Environment Setup
                ...
                Resource Link: VS Code Docs, Python venv Docs
            ...
            Project 02: Python Basics Calculator
                ...
                Resource Link: Udemy: 100 Days of Code (Relevant sections)

        Micro-Sprint (Optional): Coursera - Introduction to FastAPI Guided Project (Link)

        Practice: HackerRank Easy Python problems.
...
Sub-Phase 1.2: Data Structures & Basic Algorithms
    ...
    Week 2: Lists, Dictionaries & Control Flow
        ...
        Practice: HackerRank Easy/Medium Python problems.
...
Sub-Phase 1.3: Object-Oriented Programming (OOP) & File I/O
    ...
    Week 3: Classes, Objects & Advanced File Handling
        ...
        Practice: HackerRank Medium Python problems.
...
Core Resource: Coursera - IBM AI Engineering Professional Certificate (13 courses)
    ...
    Week 5: Data Manipulation & Visualization
        ...
        Projects:
            ...
            Project 10: Sales Data Analysis Dashboard
                ...
                Resource Link: IBM AI Eng. PC (Relevant courses/modules), Udemy: Machine Learning A-Z (Data Preprocessing sections)

            Project 11: Stock Market Monitor

                Tasks: Fetch historical stock data, calculate moving averages, visualize price trends.

                Resource Link: IBM AI Eng. PC

        Micro-Sprint: Coursera - Sales Performance Dashboard with Plotly & Dash Guided Project (Link)
...
Sub-Phase 2.2: Classical Machine Learning Algorithms
    ...
    Week 6: Supervised Learning (Regression & Classification)
        ...
        Core Resource: Coursera - Machine Learning Specialization (Andrew Ng) (Link) - For deeper theoretical understanding.
...
Sub-Phase 2.3: Model Evaluation & Improvement
    ...
    Week 7: Unsupervised Learning & Model Tuning
        ...
        Core Resource: Coursera - Machine Learning Specialization (Andrew Ng)
    ...
    Week 8: Neural Networks Basics & MLOps Intro
        ...
        Projects:
            ...
            Project 16: Basic Image Classifier
                ...
                Resource Link: IBM AI Eng. PC (Courses on Deep Learning)

            Project 17: End-to-End ML Platform (Conceptual Design)

                Tasks: Design a basic MLOps pipeline (data -> model -> deploy).

                Resource Link: IBM AI Eng. PC (MLOps/Deployment modules)

        Micro-Sprint: Coursera - Build a CI/CD Pipeline with Docker Guided Project (Link)

Phase 3: AI Agents & Deep Learning (Weeks 9-12)

Core Resource: Coursera - IBM Generative AI Engineering Professional Certificate (16 courses)
    ...
    Week 9: Advanced CNNs & RNNs
        ...
        Projects:
            ...
            Project 18: Advanced Image Recognition
                ...
                Tasks: Fine-tune pre-trained CNNs for custom datasets.

                Resource Link: Coursera: TensorFlow in Practice Specialization
        ...
        Core Resource: Coursera - DeepLearning.AI TensorFlow in Practice Specialization (Link)
    ...
    Week 10: LLM Basics & Prompt Engineering
        ...
        Projects:
            ...
            Project 20: Text Summarizer
                ...
                Resource Link: IBM Gen AI Eng. PC
        ...
        Core Resource: Coursera - DeepLearning.AI Generative AI with Large Language Models (LLMs) Specialization (Link)
    ...
    Week 11: Retrieval Augmented Generation (RAG) & LangChain
        ...
        Projects:
            ...
            Project 23: RAG-based Chatbot
                ...
                Tasks: Enhance a chatbot with RAG capabilities for contextual responses.

                Resource Link: IBM Gen AI Eng. PC

        Micro-Sprint: Coursera - LangChain Course for LLM App Development (Link)
...
Sub-Phase 3.4: Building AI Agents & Orchestration
    ...
    Week 12: Multi-Agent Systems & Tool Use
        ...
        Micro-Sprint: Coursera - Generative AI with Vertex AI: Build a Customer Chatbot Guided Project (Link)

Phase 4: MLOps & Infrastructure as Code (Weeks 13-16)

Core Resource Option 1 (Azure Focus): Coursera - Microsoft AI & ML Engineering Professional Certificate (5 courses)
Core Resource Option 2 (Multi-Cloud/Advanced): Coursera - Duke MLOps Specialization (4 courses)
    ...
    Week 13: Dockerizing ML Applications & Kubernetes Basics
        ...
        Projects:
            ...
            Project 26: Containerized ML Service
                ...
                Resource Link: Microsoft AI & ML Eng. PC or Duke MLOps Spec.

            Project 27: Kubernetes Deployment for ML

                Tasks: Deploy the containerized ML service to a local Kubernetes cluster (Minikube/Docker Desktop K8s).

                Resource Link: Microsoft AI & ML Eng. PC or Duke MLOps Spec.

        Micro-Sprint: Coursera - Pod Management with Kubernetes Guided Project (Link)
    ...
    Week 15: Terraform for Cloud Infrastructure
        ...
        Projects:
            ...
            Project 30: Cloud Infrastructure Provisioning
                ...
                Resource Link: Coursera: Terraform Basics – Managing IaC course
        ...
        Core Resource: Coursera - HashiCorp Certified: Terraform Associate (Official Exam Prep) (Link)

        Micro-Sprint: Coursera - Terraform for Beginners Guided Project (Link)
...
Documentation & References (Ongoing)
    ...
    Notion Tracker: https://www.notion.so/23965cb0a04180629afbd8967ba2b01e?v=23965cb0a04180c68a1f000cf7ded9a0&source=copy_link
